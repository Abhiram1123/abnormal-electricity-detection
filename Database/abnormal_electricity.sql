...
MySQL - 5.5.29 : Database - abnormal_electricity
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`abnormal_electricity` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `abnormal_electricity`;
...
/*Table structure for table `remote_user_abnormal_electricity` */

DROP TABLE IF EXISTS `remote_user_abnormal_electricity`;

CREATE TABLE `remote_user_abnormal_electricity` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Consumer_ID` varchar(3000) NOT NULL,
  `Region` varchar(3000) NOT NULL,
  `Season` varchar(3000) NOT NULL,
  `Meter_Type` varchar(3000) NOT NULL,
  `Consumer_Type` varchar(3000) NOT NULL,
  `Average_Usage_kWh` varchar(3000) NOT NULL,
  `Peak_Usage_kWh` varchar(3000) NOT NULL,
  `Min_Usage_kWh` varchar(3000) NOT NULL,
  `Number_of_Outages` varchar(3000) NOT NULL,
  `Usage_Pattern` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=latin1;

/*Data for the table `remote_user_abnormal_electricity` */


/*Table structure for table `remote_user_abnormal_electricity_accuracy` */

DROP TABLE IF EXISTS `remote_user_abnormal_electricity_accuracy`;

CREATE TABLE `remote_user_abnormal_electricity_accuracy` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `names` varchar(300) NOT NULL,
  `ratio` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
...
/*Data for the table `remote_user_abnormal_electricity_accuracy` */
