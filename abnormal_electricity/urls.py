"""abnormal_electricity URL Configuration
...
from abnormal_electricity import settings
...
urlpatterns = [
    ...
    url(r'^Predict_abnormal_electricity/$', remoteuser.Predict_abnormal_electricity, name="Predict_abnormal_electricity"),
    ...
    url(r'^View_abnormal_electricity_Ratio/$', serviceprovider.View_abnormal_electricity_Ratio, name="View_abnormal_electricity_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_abnormal_electricity/$', serviceprovider.View_abnormal_electricity, name="View_abnormal_electricity"),
